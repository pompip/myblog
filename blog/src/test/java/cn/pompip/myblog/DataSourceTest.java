...
public class DataSourceTest {
    ...
    public void MyTest() {
            ...
            sqlSession = getSqlSession2(dataSource);
    ...
    public void testMapper() {
        ...
        mapper.findAll().forEach(entity -> System.out.println(entity.getTitle()));
    }
     ...
     * @return
     */
    private SqlSession getSqlSession2(DataSource dataSource){
